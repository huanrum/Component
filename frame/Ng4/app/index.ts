...
import { Component, NgModule, PACKAGE_ROOT_URL} from '@angular/core';
...
@NgModule({
    ...
    declarations: [ AppComponent,...Object.values(component)],
    providers: [
        { provide: APP_BASE_HREF, useValue : '/' },
        //{ provide: PACKAGE_ROOT_URL, useValue : 'app/component/' },
