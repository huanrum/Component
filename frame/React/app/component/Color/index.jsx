                        ...
                        <div className="show-dialog-panel">
                            <div className="show-dialog">
                                ...
                                <div className="content">
                                    ...
                                    {
                                        colors.map(color=><div key={color} className={'component-color-content ' + (this.state.value==color?'selected':'')} style={{background:color}} onClick={()=>this.setState({value:color})}>{color}</div>)
                                    }
                                </div>
